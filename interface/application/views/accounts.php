    ...
    <div class="container" style="height: 100%">
      <div class="verticalalign">
        <div class="bs-header text-center title-font" >
          <h1>What type of account do you want to view?</h1>
        </div>
          <div class="dropdown" style="margin-left: auto; margin-right: auto; width: 101px">
            <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">Account <span class="caret"></span>
            </button>
            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
              <li role="presentation"><a role="menuitem" tabindex="-1" href="voter.html">Voter</a></li>
              <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Candidate</a></li>
              <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Admin</a></li>
              <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Monitor</a></li>
            </ul>
          </div>
      </div>
    </div>
